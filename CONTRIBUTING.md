# Contributing to PCSX2 Helm Chart
...
helm template pcsx2 chart/

# Install in a test cluster
helm install pcsx2-test chart/ --dry-run --debug
```
...
- Update `appVersion` in `Chart.yaml` in your PR when pinning the chart to a specific PCSX2 image
